...
class LanguageDetector:
    ...
    def __init__(self, model_type="svm_improved"):
        ...
        if model_type == "svm":
        ...
        elif model_type == "svm_improved":
            self._load_svm_improved()
            ...
            raise ValueError("model_type must be svm, svm_improved, nb, or cnn")
    ...
    # ---------- IMPROVED SVM ----------
    def _load_svm_improved(self):

        print("Loading Improved LinearSVM")
    ...
    def predict(self, text):
        ...
        if self.model_type in ["svm", "svm_improved", "nb"]:
